...
const DashboardForm = () => {
    ...
    return (
        ...
        >
                ...
                <Row gutter={[24, 4]}>
                    <Col span={12}>
                        <span className="font-semibold text-xs  ">
                            {translations(
                                "dashboardForm.CreatePRtoPO.RFQNumber"
                            )}
                        </span>
                        <Input
                            type="string"
                    ...
                    <Col span={12}>
                        <span className="font-semibold text-xs ">
                            {translations(
                                "dashboardForm.CreatePRtoPO.supplierName"
                            )}
                        </span>
                        <Input
                            type="string"
                    ...
                    <Button className={styles.formSearchBar}>
                        <div className="flex text-center">
                            <p className=" flex font-normal pr-4 text-base self-start  ">
                                {translations(
                                    "dashboardForm.CreatePRtoPO.searchBar"
                                )}
                            </p>
            ...
            <FormTable />
            <Form.Item className={styles.inputMargin}>
                <span className="flex font-semibold gap-4  justify-end">
                    <Button className={styles.createBtn} htmlType="submit">
                        <p className="font-semibold text-base self-center ">
                            {translations(
                                "dashboardForm.CreatePRtoPO.createBtn"
                            )}
                        </p>
                    </Button>
                    <Button className={styles.cancelBtn}>
                        <p className="font-semibold text-base self-center ">
                            {translations(
                                "dashboardForm.CreatePRtoPO.cancelBtn"
                            )}
                        </p>
                    </Button>
                </span>
