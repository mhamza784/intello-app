...
const DashboardForm = () => {
    ...
    return (
        ...
        >
            ...
            <FormTable />
            <Form.Item>
                <span className="gap-2  flex font-semibold mr-10  justify-end">
                    <Button className={styles.FrqFormBtn} htmlType="submit">
                        <p className="font-semibold text-base self-center ">
                            {translations("dashboardForm.rfq.buttonForm.save")}
                        </p>
                    </Button>
                    <Button type="primary" className={styles.frqPrimaryBtn}>
                        {translations("dashboardForm.rfq.buttonForm.create")}
                    </Button>
                </span>
            </Form.Item>
        </Form>
